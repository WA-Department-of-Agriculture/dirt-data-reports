...
# be converted to numeric. Non-numeric values (e.g. "ND", "NA", "", "-", "<1")
...
# Convert measurement columns to numeric. This will emit a warning of which
# columns have converted a value to NA.
