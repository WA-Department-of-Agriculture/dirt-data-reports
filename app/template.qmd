...
<!--Add JS event listener to change colors of tabs based on text -->
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    navLinks.forEach(link => {
        switch (link.textContent.trim()) {
            case "Biological":
                link.style.color = "#335c67";
                break;
            case "Chemical":
                link.style.color = "#d4820a";
                break;
            case "Physical":
...
#example with chromote instead of webshot
# if (exists("map") &&
#     requireNamespace("htmlwidgets", quietly = TRUE) &&
...
# 
#   # Save widget as HTML
#   html_file <- glue::glue("{path}/map.html")
#   saveWidget(map, file = html_file)
# 
#   # Use Chromote to capture a screenshot
#   img_file <- glue::glue("{path}/map.png")
#   b$Page$navigate(paste0("file://", normalizePath(html_file)))
#   Sys.sleep(2) # Allow time for page to load
#   b$screenshot(filename = img_file)
# 
#  # cat("Map successfully saved as an image using Chromote!")
# }
