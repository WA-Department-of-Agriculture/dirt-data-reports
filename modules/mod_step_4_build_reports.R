...
")),
    div(
      ...
      p(class = "form-text",       "Choose the year and up to five producers to build reports for. Producer IDs listed will automatically update based on the year selected. Reports will be generated in a zip file within your Downloads folder."
),
      div(class = "col-2",
    ...
    output$report <- downloadHandler(
      ...
      content = function(file) {
        ...
        showModal(modalDialog(
          ...
          tags$div(
            id = "modalContent",
            tags$div(class = "progress-section",
                     ...
                     tags$div(class = "progress-wrapper",
                              tags$div(id = "progressBar", class = "progress-bar", "0%")
                     )
            ),
            tags$div(id = "successMessage", class = "message",
                     tags$i(class = "fas fa-check-circle", style='color:#023B2C'),
                     tags$h3("Success!"),
                     tags$p(id = "successText", ""),
                     tags$button("Close", id = "dynamicCloseBtn", class="btn btn-secondary",
                                 style = "margin-top: 1rem; display: none;")
            ),
            tags$div(id = "errorMessage", class = "message", style = "display:none;",
                     ...
                     div(style="display:flex;justify-content:space-between;margin-top:10px",
                       tags$button("Report Issue", id = "reportIssueBtn",
                       ...
                       tags$button("Close", id = "errorCloseBtn",
    ...
    ")
        ...
        withr::with_dir(temp_dir, {
          for (i in seq_len(nrow(render_df))) {
            ...
            session$sendCustomMessage("updateProgressModal", list(
              step = progress_step,
        ...
        if (length(failed_reports) == 0) {
          ...
          session$sendCustomMessage("showErrorModal", list(
            message = fail_msg,
